...
<body>
    ...
    <div class="rowflex">
        ...
        <div class="columnflex">
            ...
            <div style="font-size: 20px; display: flex; justify-content: space-between; width: 100%;">
            <p>£26</p><i class="bi bi-handbag"></i>
            </div>
            </div>
    ...
    <div class="rowflex"></div>
       <div class="columnflex">
            ...
            <div style="font-size: 20px; display: flex; justify-content: space-between; width: 100%;">
            <p>£44</p><i class="bi bi-handbag"></i>
            </div>
       </div>
       ...
       <div class="columnflex">
            ...
            <div style="font-size: 20px; display: flex; justify-content: space-between; width: 100%;">
            <p>£107</p><i class="bi bi-handbag"></i>
            </div>
        </div>
   ...
   <div class="rowflex">
    <div class="columnflex">
        ...
        <div style="font-size: 20px; display: flex; justify-content: space-between; width: 100%;">
        <p>£65</p><i class="bi bi-handbag"></i>
        </div>
    ...
    <div class="columnflex">
        ...
        <div style="font-size: 20px; display: flex; justify-content: space-between; width: 100%;">
        <p>£49</p><i class="bi bi-handbag"></i>
        </div>
    ...
    <div class="columnflex">
        ...
        <div style="font-size: 20px; display: flex; justify-content: space-between; width: 100%;">
        <p>£33</p><i class="bi bi-handbag"></i>
        </div>
